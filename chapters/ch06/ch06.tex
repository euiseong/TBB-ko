...
\begin{tbbitemize}
  \item \textbf{[이번 주] AWS S3 documentation: "Performance Guidelines" and "Optimizing Amazon S3 Performance"} — §6.3 로더의 1차 자료다. 접두사별 요청 병렬 처리, 범위 GET, 멀티파트(multipart) 임곗값을 다룬다. 짧고 구체적이며 같은 아이디어가 GCS에도 적용된다.
